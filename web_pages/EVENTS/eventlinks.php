...
<div><h2>Links for Events</h2></div>
</br>
<p>
...
// Event Info  
$query = "CALL event1_1('$event_name')";  
$result = mysqli_query($dbcon, $query)
  or die('Sorry, no results found. Please try again.'); 
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "Here are links for $event_name:";
        echo "<tr>
              <td>" . $row["url"] . "</td>
  ...
  echo "Oops, no links found in our database for event $event_name! </br>";
